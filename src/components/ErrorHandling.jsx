  ...
  if (errMsg.msg === 'Not logged in') {
    return (
      <section className="errors">
        <h2>Hmmmm...</h2>
        <p>That's not working. Are you sure you're logged in?</p>
      </section>
    );
  }
  if (errMsg.msg === 'path not found') {
    return (
      <section className="errors">
        <h2>Hmmmm...</h2>
        <p>
          Something's gone wrong here. Looks like you've not found something
          that doesn't exist. Confused? Me too.
        </p>
